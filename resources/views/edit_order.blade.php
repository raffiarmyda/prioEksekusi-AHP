...
@section('container')
    ...
    <div class="card-body">
        <form method="post" action="{{ url('update_order',$orders->id) }}">
            @csrf
            <div class="from-group">
                <label for="sidnim">SIDNIM</label>
                <input type="text" name="sidnim" class="form-control @error('sidnim') is-invalid @enderror" id="sidnim" placeholder="Masukkan SIDNIM" value="{{$orders->sidnim}}">
            ...
            <div class="from-group">
                ...
                <input type="text" name="longitude" class="form-control @error('longitude') is-invalid @enderror" id="longitude" placeholder="Masukkan Longitude" value="{{$orders->longitude}}">
            ...
            <div class="from-group">
                ...
                <input type="text" name="latitude" class="form-control @error('latitude') is-invalid @enderror" id="latitude" placeholder="Masukkan Latitude" value="{{$orders->latitude}}">
            ...
            <div class="form-group">
                ...
                <select name="witel" class="form-select" id="witel">
                    <option selected>{{$orders->witel}}</option>
            ...
            <div class="form-group">
                ...
                <select name="sto" class="form-select" id="sto">
                    <option selected>{{$orders->sto}}</option>
            ...
            <div class="form-group">
                ...
                <select name="bts_status" class="form-select" id="bts_status">
                    <option selected>{{$orders->bts_status}}</option>
            ...
            <div class="from-group">
                ...
                <input type="text" name="billed_bandwidth" class="form-control @error('billed_bandwidth') is-invalid @enderror" id="billed_bandwidth" placeholder="Masukkan BILLED BANDWIDTH" value="{{$orders->billed_bandwidth}}">
            ...
            <div class="from-group">
                ...
                <input type="text" name="request_metroport" class="form-control @error('request_metroport') is-invalid @enderror" id="request_metroport" placeholder="Masukkan METRO PORT" value="{{$orders->request_metroport}}">
            ...
            <div class="from-group">
                ...
                <input type="text" name="request_oltport" class="form-control @error('request_oltport') is-invalid @enderror" id="request_oltport" placeholder="Masukkan OLT PORT" value="{{$orders->request_oltport}}">
            ...
            <div class="from-group">
                ...
                <input type="text" name="request_ontport" class="form-control @error('request_ontport') is-invalid @enderror" id="request_ontport" placeholder="Masukkan ONT PORT" value="{{$orders->request_ontport}}">
            ...
            <div class="from-group">
                ...
                <input type="text" name="request_switch" class="form-control @error('request_switch') is-invalid @enderror" id="request_switch" placeholder="Masukkan SWITCH PORT" value="{{$orders->request_switch}}">
            ...
            <div class="from-group">
                ...
                <input type="text" name="input_by" class="form-control @error('input_by') is-invalid @enderror" id="input_by" placeholder="Masukkan Nama Yang Memasukkan Data" value="{{$orders->input_by}}">
            ...
            <div class="from-group">
                ...
                <input type="date" name="input_at" class="form-control @error('input_at') is-invalid @enderror" id="input_at" placeholder="Diinput Pada Tanggal" value="{{old('input_at',$orders->input_at)}}">
            ...
            <div class="from-group">
                ...
                <input type="text" name="comment" class="form-control @error('comment') is-invalid @enderror" id="comment" placeholder="Masukkan Nama Yang Memasukkan Data" value="{{$orders->comment}}">
